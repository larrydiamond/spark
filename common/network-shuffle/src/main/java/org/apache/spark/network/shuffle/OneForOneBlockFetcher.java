...
public class OneForOneBlockFetcher {
  ...
  return true;
    ...
    */
    private FetchShuffleBlocks createFetchShuffleBlocksMsg(String appId, String execId, String[] blockIds) {
  ...
  if (Integer.parseInt(blockIdParts[1]) != shuffleId) {
    ...
    */
    ...
    String[] blockIdParts = blockId.split("_");
      if (blockIdParts.length < 4 || blockIdParts.length > 5 || !"shuffle".equals(blockIdParts[0])) {
